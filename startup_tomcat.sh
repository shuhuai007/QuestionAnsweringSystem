...
WAR_VERSION=thougtworks-cieg-0.1
...
rm -rf ~/tomcat-8.0.27/apache-tomcat-8.0.27/webapps/${WAR_VERSION}
echo old webapps directory deleted
cp deep-qa-web/target/${WAR_VERSION}.war ~/tomcat-8.0.27/apache-tomcat-8.0.27/webapps/
...
echo ${WAR_VERSION} has been started
